...
public class PlayerController : MonoBehaviour {
	...
	//SOMETHING ABOUT THIS IS BUGGED AND I DONT UNDERSTAND WHAT. RESULT IS STEEP-SLOPES ARE RETURNING AIR TOO OFTEN. PROBABLY calcSlopeStairAltitude()
		switch (naive_state) {
	...
	void MovePlayer() {
		...
		body.linearDamping = motion_drag; //TODO MOVE THIS TO GROUND_STATE switch
